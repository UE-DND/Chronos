...
<div class="flex min-h-0 flex-1 flex-col">
	...
	>
		...
		<div
			class="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/55 to-transparent px-4 pt-10 pb-3"
		>
			<p class="text-body-small text-center text-white/90">{hint}</p>
		</div>
	</div>
