...
<div class="flex min-h-0 flex-1 flex-col overflow-y-auto">
	<header class="border-b border-outline/10 bg-surface px-4 pt-6 pb-4">
		...
		<div
			class="relative mt-4 flex w-full rounded-full border border-border bg-surface p-1.5 shadow-xs"
		>
			...
			{#each scopeSegments as segment (segment.value)}
				<button
					type="button"
					class="m3-label-large relative z-10 flex-1 cursor-pointer rounded-full py-2 text-center transition-colors duration-200 {screen.scope ===
					segment.value
