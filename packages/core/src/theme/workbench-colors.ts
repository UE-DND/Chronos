...
export const WORKBENCH_COLOR_KEYS = [
	...
	'color.scrim',
	'color.on-on-primary',
	'color.tertiary-container-subtle',
	'color.on-tertiary-container-subtle',
	'color.error-container-subtle',
	'color.on-error-container-subtle',
...
export const WORKBENCH_COLOR_REGISTRY: Record<WorkbenchColorKey, WorkbenchColorDefinition> = {
	'color.surface-dim': { cssVar: '--color-surface-dim' },
	'color.surface-bright': { cssVar: '--color-surface-bright' },
	'color.surface-container-lowest': { cssVar: '--color-surface-container-lowest' },
	'color.surface-container-low': { cssVar: '--color-surface-container-low' },
	'color.surface-container': { cssVar: '--color-surface-container' },
	'color.surface-container-highest': { cssVar: '--color-surface-container-highest' },
	'color.on-surface-variant': { cssVar: '--color-on-surface-variant' },
	'color.inverse-surface': { cssVar: '--color-inverse-surface' },
	'color.inverse-on-surface': { cssVar: '--color-inverse-on-surface' },
	'color.primary-fixed': { cssVar: '--color-primary-fixed' },
	'color.primary-fixed-dim': { cssVar: '--color-primary-fixed-dim' },
	'color.on-primary-fixed': { cssVar: '--color-on-primary-fixed' },
	'color.on-primary-fixed-variant': { cssVar: '--color-on-primary-fixed-variant' },
	'color.secondary-fixed': { cssVar: '--color-secondary-fixed' },
	'color.secondary-fixed-dim': { cssVar: '--color-secondary-fixed-dim' },
	'color.on-secondary-fixed': { cssVar: '--color-on-secondary-fixed' },
	'color.on-secondary-fixed-variant': { cssVar: '--color-on-secondary-fixed-variant' },
	'color.tertiary': { cssVar: '--color-tertiary' },
	'color.tertiary-dim': { cssVar: '--color-tertiary-dim' },
	'color.on-tertiary': { cssVar: '--color-on-tertiary' },
	'color.tertiary-container': { cssVar: '--color-tertiary-container' },
	'color.on-tertiary-container': { cssVar: '--color-on-tertiary-container' },
	'color.tertiary-fixed': { cssVar: '--color-tertiary-fixed' },
	'color.tertiary-fixed-dim': { cssVar: '--color-tertiary-fixed-dim' },
	'color.on-tertiary-fixed': { cssVar: '--color-on-tertiary-fixed' },
	'color.on-tertiary-fixed-variant': { cssVar: '--color-on-tertiary-fixed-variant' },
	'color.error': { cssVar: '--color-error' },
	'color.error-dim': { cssVar: '--color-error-dim' },
	'color.on-error': { cssVar: '--color-on-error' },
	'color.error-container': { cssVar: '--color-error-container' },
	'color.on-error-container': { cssVar: '--color-on-error-container' },
	'color.shadow': { cssVar: '--color-shadow' },
	'color.scrim': { cssVar: '--color-scrim' },
	'color.on-on-primary': { cssVar: '--color-on-on-primary' },
	'color.tertiary-container-subtle': { cssVar: '--color-tertiary-container-subtle' },
	'color.on-tertiary-container-subtle': { cssVar: '--color-on-tertiary-container-subtle' },
	'color.error-container-subtle': { cssVar: '--color-error-container-subtle' },
	'color.on-error-container-subtle': { cssVar: '--color-on-error-container-subtle' },
