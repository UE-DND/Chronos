<script lang="ts">
	...
	async function handleHtmlFileChange(event: Event) {
...
<div class="mx-auto flex w-full max-w-lg flex-col gap-5 py-1">
	...
	<div class="w-full">
		{#if activeTabId === 'cqut-online' && onlineImportEnabled}
		...
		{:else if activeTabId === 'share-link'}
			<Card variant="outlined">
				<div class="flex flex-col gap-4 p-2">
					<div>
