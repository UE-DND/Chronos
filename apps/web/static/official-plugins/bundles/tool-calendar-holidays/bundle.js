...
var Vr = Symbol.for("chronos.mountable");
...
Wr(ua("light"), ua("dark")), typeof window < "u" && ((window.__svelte ??= {}).v ??= /* @__PURE__ */ new Set()).add("5"), Jn(["input"]), Jn(["change"]), Jn(["change"]), Jn(["change"]), Jn(["click"]), Jn(["change"]), Jn(["click"]), Jn(["click"]), Jn(["click"]);
//#endregion
...
async function Sa(e, t = {}) {
	...
	if (i) return i;
	let a = wa(e, r, n.academicConfig, t).finally(() => {
		ba.delete(r);
	});
	return ba.set(r, a), a;
}
async function Ca(e, t = {}) {
	return e.state.currentTimetable ? Sa(e, t) : !1;
}
async function wa(e, t, n, r) {
	let i = Ir(n), a = e.service(zr), o = await a.getTimetable(t);
	if (!o) throw Error(`Timetable not found: ${t}`);
	if (!r.force && !xa(o.academicConfig.holidayCalendar, i)) return !1;
	let { holidays: s } = await ya(e.service(Rr), i), c = {
		holidays: s,
		syncedAt: Date.now(),
		syncedYears: [...i]
	}, l = {
...
var Ea = /* @__PURE__ */ nr("<p class=\"text-body-small mt-1 text-on-surface-variant\"> </p>"), Da = /* @__PURE__ */ nr("<p class=\"text-body-medium py-6 text-center text-on-surface-variant\"> </p>"), Oa = /* @__PURE__ */ nr("<li class=\"py-3\"><span class=\"text-body-medium text-on-surface\"> </span></li>"), ka = /* @__PURE__ */ nr("<div class=\"mt-3 mb-3\"><p class=\"text-label-large mb-1 text-on-surface-variant\"> </p> <ul class=\"divide-y divide-outline/10\"></ul></div>"), Aa = /* @__PURE__ */ nr("<p class=\"text-body-small text-error\"> </p>"), ja = /* @__PURE__ */ nr("<div class=\"flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-4\"><section class=\"rounded-2xl border border-outline/20 bg-surface p-4 shadow-xs\"><h2 class=\"text-title-medium text-on-surface\"> </h2> <p class=\"text-body-medium mt-2 text-on-surface-variant\"> </p> <a class=\"text-body-small mt-2 inline-block text-primary\" href=\"https://github.com/NateScarlet/holiday-cn\" target=\"_blank\" rel=\"noreferrer\"> </a></section> <section class=\"rounded-2xl border border-outline/20 bg-surface p-4 shadow-xs\"><h3 class=\"text-title-small text-on-surface\"> </h3> <!> <p class=\"text-body-small mt-2 text-on-surface-variant\"> </p> <button type=\"button\" class=\"text-label-large mt-4 w-full rounded-full bg-primary px-4 py-3 text-on-primary disabled:opacity-50\"> </button></section> <section class=\"rounded-2xl border border-outline/20 bg-surface p-4 shadow-xs\"><h3 class=\"text-title-small text-on-surface\"> </h3> <!></section> <!></div>");
function Ma(e, t) {
	je(t, !0);
	let n = /* @__PURE__ */ kt(!1), r = /* @__PURE__ */ kt(null), i = /* @__PURE__ */ tt(() => t.controller.currentTimetable), a = /* @__PURE__ */ tt(() => L(i)?.academicConfig.holidayCalendar), o = /* @__PURE__ */ tt(() => L(i) && L(a) ? Fr(L(a).holidays, L(i).academicConfig) : []), s = /* @__PURE__ */ tt(() => L(i) ? Ir(L(i).academicConfig).join(u("screen.sync.yearSeparator")) : ""), c = /* @__PURE__ */ tt(() => d(L(o), t.controller.currentLocale)), l = /* @__PURE__ */ tt(() => !!L(a)?.syncedAt);
	function u(e) {
	...
	async function m() {
		...
		try {
			...
			await Sa(e, { force: !0 }), e.actions.notify(u("screen.notify.synced"), "info");
		} catch (e) {
	...
	var le = Kt(se, 2), ue = (e) => {
		...
		vr(Gt(n), 17, () => L(c), (e) => e.month, (e, n) => {
			var r = ka(), i = j(r), a = j(i, !0);
			O(i);
			var o = Kt(i, 2);
			vr(o, 21, () => L(n).items, (e) => e.date, (e, n) => {
				var r = Oa(), i = j(r), a = j(i, !0);
...
var Na = Ta({ screenComponent: da(Ma) });
//#endregion
