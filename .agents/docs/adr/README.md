...
| [ADR 0014](./0014-wallpaper-official-marketplace-only.md)                  | **课表壁纸退役 Profile 预设、转纯在线官方插件分发**   | Proposed               | `packages/plugins/wallpaper`, `apps/web` | 壁纸与 YUMEMITA 同轨经 catalog 在线分发，Profile 瘦身；PluginScreenContainer mountable 富 UI 通道与构建 CSS 归属修复 |
