...
Chronos 的核心功能仅为查看与分享课表。另外，您可在「插件中心」安装 Chronos 自带的，或第三方插件以个性化使用体验。

受 [DeepSeek-Hardness](https://github.com/deepseek-ai/deepseek-harness) 启发，Chronos 的许多能力同样由插件形式构成，并由内置的轻量运行时框架驱动。这一架构也为定制不同学校的专用版本带来了极大便利。
...
此项目正处于快速演进阶段，若发现已知的问题，欢迎任何形式的贡献！无论是修复错误、改进功能，还是提升代码质量，我们都非常欢迎您的参与。
